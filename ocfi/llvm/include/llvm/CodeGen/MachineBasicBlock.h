...
private:
  ...
  bool IsObfuscatedBegin = false;

  bool IsObfuscatedEnd = false;

  bool IsOutObfuscateRange = false;

  bool IsObfuscateInitialize = false;
...
public:
  ...
  void setOutObfuscateRange(bool V = true) {
    IsOutObfuscateRange = V;
  }

  const bool isOutObfuscateRange() { return IsOutObfuscateRange; }

  void setObfuscateInitialize(bool V = true) {
    IsObfuscateInitialize = V;
  }

  bool isObfuscateInitialize() { return IsObfuscateInitialize; }
  ...
  /// Returns true if this block begins any obfuscated structure.
  bool isObfuscatedBegin() const { return IsObfuscatedBegin; }

  /// Returns true if this block ends any obfuscated structure.
  bool isObfuscatedEnd() const { return IsObfuscatedEnd; }

  void setIsObfuscatedBegin(bool V = true) { IsObfuscatedBegin = V; }

  void setIsObfuscatedEnd(bool V = true) { IsObfuscatedEnd = V;}
